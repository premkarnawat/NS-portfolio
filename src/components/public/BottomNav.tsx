...
import { Grid3X3, Award, Sun, Moon, FolderOpen, FileText } from 'lucide-react'
...
export default function BottomNav({ screen, onScreen, onThemeToggle, isDark }: Props) {
  ...
  const items = [
    ...
    { icon: Award, action: () => onScreen('certifications'), active: screen === 'certifications', key: 'certifications' },
